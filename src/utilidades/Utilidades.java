...
=======
/* Actualizado a 20/11/2025 por Leire Trabado*/
package utilidades;
...
public class Utilidades {
	...
	// Muestra el mensaje y luego lee el numero(double) introducido si es entre los
	...
	public static String introducirCadena(String palabra1, String palabra2) {
		...
		do {
			...
			try {
				...
				if (!cadena.equalsIgnoreCase(palabra1) && !cadena.equalsIgnoreCase(palabra2)) {
					System.out.println(
							"Error, la opción introducida no es correcta, introduce " + palabra1 + " o " + palabra2);
					error = true;
				}
	...
	public static String introducirCadena(String palabra1, String palabra2, String palabra3) {
		...
		do {
			...
			try {
				...
				cadena = cadena.trim().toUpperCase();
				if (!cadena.equalsIgnoreCase(palabra1) && !cadena.equalsIgnoreCase(palabra2)
						&& !cadena.equalsIgnoreCase(palabra3)) {
					System.out.println("Error, la opción introducida no es correcta, introduce " + palabra1 + " o "
							+ palabra2 + " o " + palabra3);
					error = true;
				}
	...
	public static boolean leerBoolean(String mensaje) {
		...
		do {
			...
			cadena = introducirCadena().trim().toUpperCase(); // Quitamos espacios y pasamos a mayúsculas
...
>>>>>>> branch 'main' of https://github.com/cj2339/RETO_PROGRAM_ING
}